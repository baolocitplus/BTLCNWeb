            ...
            <ul class="nav navbar-nav navbar-right top-navbar">
                    ...
                    <ul class="dropdown-menu dropdown-message">
                        ...
                        <li class="unread">
                            <a href="#" class="clearfix">
                                <img src="{{asset('images/users/chat/2.jpg')}}" class="xs-avatar ava-dropdown"
                                     alt="Avatar">
                        ...
                        <li class="unread">
                            <a href="#" class="clearfix">
                                <img src="{{asset('images/users/chat/1.jpg')}}" class="xs-avatar ava-dropdown"
                                     alt="Avatar">
                        ...
                        <li>
                            <a href="#" class="clearfix">
                                <img src="{{asset('images/users/chat/3.jpg')}}" class="xs-avatar ava-dropdown"
                                     alt="Avatar">
                ...
                <li class="dropdown topbar-profile">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span
                                class="rounded-image topbar-profile-image"><img src="{{asset('images/users/user-35.jpg')}}"></span>
                        {{Auth::guard('company')->user()->name}} <i class="fa fa-caret-down"></i></a>
